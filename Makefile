...
# repo's release.yml is byte-identical. OPENBLOCKS_VERSION still works as an explicit
...
OPENBLOCKS_VERSION ?= $(RELEASE_VERSION)
...
test: $(TEST_BIN) $(TEST_INPUT_BIN) $(TEST_MENU_BIN)
	./$(TEST_BIN)
	./$(TEST_INPUT_BIN)
	./$(TEST_MENU_BIN)
